...
public class App 
{
    ...
    public static void run(){
         ...
         */
            ...
            n=1;
            do {
                driver.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div[2]/div/div[2]/div[1]/ul/li["+n+"]")).click();
                s = driver.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div[2]/div/div[2]/div[1]/ul/li["+n+"]")).getText();
                n++;
         ...
         */
            ...
            s="";
            do {
                driver.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div[2]/div/div[2]/div[2]/ul/li["+n+"]")).click();
                s = driver.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div[2]/div/div[2]/div[2]/ul/li["+n+"]")).getText();
                n++;
         ...
         */
            ...
            n=1;
            do {
                driver.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div[2]/div/div[2]/div[3]/ul/li["+n+"]")).click();
                s = driver.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div[2]/div/div[2]/div[3]/ul/li["+n+"]")).getText();
                n++;
